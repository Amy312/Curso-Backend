...
import { RedisCacheService } from './../../../src/infrastucture/cache/redis.cache';
import { Encrypt } from './../../../src/app/utils/encrypt';
import { UserRepositoryImpl } from './../../../src/infrastucture/repositories/user.reposity';
import { EncryptImpl } from './../../../src/infrastucture/utils/encrypt';
...
describe('AuthService', () => {
    ...
    beforeEach(() => {
        ...
        authService = new AuthService(userRepositoryMock, encryptMock);
    });
    ...
    it('debe lanzar un error si el usuario no existe', async () => {
        ...
        try {
            ...
            expect(err.message).to.equal('El email o el password son incorrectos');
        }
    });
